{
  inputs =
    let
      version = "1.9.1";
system = "x86_64-linux";
devenv_root = "/home/columcc/scripts/nix-python-devenv";
devenv_dotfile = "/home/columcc/scripts/nix-python-devenv/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-cdc54b9";
